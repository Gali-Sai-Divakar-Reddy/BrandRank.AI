...
export const BackgroundCircles = ({ parallaxRef }) => {
  ...
  return (
    <div className="absolute top-[10rem] left-1/2  w-[5rem] h-[18rem] md:w-[55rem] md:h-[55rem] xl:[58rem] xl:h-[58rem] aspect-square -translate-x-1/2 md:top-[10rem] xl:-top-[2rem]">
